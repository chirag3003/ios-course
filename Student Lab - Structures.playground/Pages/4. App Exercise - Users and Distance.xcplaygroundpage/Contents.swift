...
var chirag = User(name: "Chirag", age: 20, height: 172, weight: 65, activityLevel: 10)
print("Hello, my name is \(chirag.name)")
print("I am \(chirag.age) years old")
print("I am \(chirag.height) meters tall")
print("I weigh \(chirag.weight) kilograms")
print("I am \(chirag.activityLevel)/10 very active")
