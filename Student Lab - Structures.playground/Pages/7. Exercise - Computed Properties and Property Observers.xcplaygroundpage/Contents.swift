...
let rec = Rectangle(width: 10, height: 4)
print(rec, "and its area = ", rec.area)
...
struct Height {
    var heightInInches: Double {
        didSet{
            ...
            if self.heightInCentimeters != cent {
                self.heightInCentimeters = cent
            }
        }
    }
...
print(h.heightInInches, " inches is equal to ", h.heightInCentimeters, " centimeters")
h.heightInInches = 72
print(h.heightInInches, " inches is equal to ", h.heightInCentimeters, " centimeters")
