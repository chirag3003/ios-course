...
let somePlace = GPS(latitiude: 51.514004, longitude: 0.125226)
print("Latitude: \(somePlace.latitiude)")
...
struct Height {
    ...
    init(heighInInches: Double){
        self.heightInInches = heighInInches
        heightInCentimeters = heighInInches * 2.54
    }
...
var someonesHeight = Height(heighInInches: 65)
