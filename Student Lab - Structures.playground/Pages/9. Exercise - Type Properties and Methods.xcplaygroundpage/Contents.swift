...
struct User {
    ...
    static var currentUser: User = User(userName: "Chirag Bhalotia", email: "chirag@gmail.com", age: 20)
 ...
 */
User.loginUser(user: User(userName: "New User", email: "user@gmail.com", age: 2))
print(User.currentUser)
/*:
